...
const ProjectsSection = () => {
    ...
    const featuredProjects = [
        ...
        },
        {
            ...
            subtitle: 'High-Performance Trading System',
            description: 'A thread-safe C++ matching engine supporting multiple order types with price-time priority and O(1) complexity for core operations.',
            features: ['Multiple Order Types (GTC, FOK, FAK)', 'Price-Time Priority Matching', 'Thread-Safe Concurrent Processing', 'O(1) Order Lookup'],
            tech: ['C++17', 'Google Test', 'CMake', 'STL'],
            image: null,
